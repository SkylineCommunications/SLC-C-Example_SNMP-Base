	...
	public class IfTableGetter
	{
		public IfTableGetter(SLProtocol protocol)
		{
			var columnsToGet = new uint[]
			{
				...
				Parameter.Iftable.Idx.iftable_ifucastpktsin_1011,
				Parameter.Iftable.Idx.iftable_ifdiscardsin_1012,
				Parameter.Iftable.Idx.iftable_iferrorsin_1013,
				Parameter.Iftable.Idx.iftable_ifunknownprotosin_1014,

				Parameter.Iftable.Idx.iftable_ifoctetsout_1015,
				Parameter.Iftable.Idx.iftable_ifucastpktsout_1016,
				Parameter.Iftable.Idx.iftable_ifdiscardsout_1017,
				Parameter.Iftable.Idx.iftable_iferrorsout_1018,
