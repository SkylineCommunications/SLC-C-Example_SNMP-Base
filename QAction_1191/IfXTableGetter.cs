	...
	public class IfXTableGetter
	{
		public IfXTableGetter(SLProtocol protocol)
		{
			var columnsToGet = new uint[]
			{
				...
				Parameter.Ifxtable.Idx.ifxtable_ifbroadcastpktsin_1104,
				Parameter.Ifxtable.Idx.ifxtable_ifmulticastpktsout_1105,
				Parameter.Ifxtable.Idx.ifxtable_ifbroadcastpktsout_1106,
				Parameter.Ifxtable.Idx.ifxtable_ifhcoctetsin_1107,
				Parameter.Ifxtable.Idx.ifxtable_ifhcucastpktsin_1108,
				Parameter.Ifxtable.Idx.ifxtable_ifhcmulticastpktsin_1109,
				Parameter.Ifxtable.Idx.ifxtable_ifhcbroadcastpktsin_1110,
				Parameter.Ifxtable.Idx.ifxtable_ifhcoctetsout_1111,
				Parameter.Ifxtable.Idx.ifxtable_ifhcucastpktsout_1112,
				Parameter.Ifxtable.Idx.ifxtable_ifhcmulticastpktsout_1113,
				Parameter.Ifxtable.Idx.ifxtable_ifhcbroadcastpktsout_1114,
				/* We currently don't need ifXTable_IfLinkUpDownTrapEnable_1115 */
				Parameter.Ifxtable.Idx.ifxtable_ifhighspeed_1116,
				Parameter.Ifxtable.Idx.ifxtable_ifpromiscuousmode_1117,
				/* We currently don't need ifXTable_IfConnectorPresent_1118 */
